...
const SearchPage = () => {
  ...
  useEffect(() => {
    if (params.text) {
      alert(params.text); // Simulated action when params.text changes
    }
  }, [params.text]);
          ...
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              ...
              <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                {["biryani", "panjabithali", "momos"].map((selectedFilter) => (
                  <div
                    key={selectedFilter}
              ...
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                    <Link to={`/restaurant/${item}`} className="inline-block">
